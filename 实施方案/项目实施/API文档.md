...
| 接口 | 方法 | 路径 | 描述 |
|------|------|------|------|
| 创建提醒 | POST | `/api/v1/reminders` | 创建任务提醒 |
| 获取提醒列表 | GET | `/api/v1/reminders` | 获取用户提醒列表 |
| 更新提醒 | PUT | `/api/v1/reminders/{reminderId}` | 更新提醒设置 |
| 删除提醒 | DELETE | `/api/v1/reminders/{reminderId}` | 删除提醒 |
| 延迟提醒 | POST | `/api/v1/reminders/{reminderId}/snooze` | 延迟提醒时间 |
| 提醒规则管理 | GET/POST/PUT | `/api/v1/reminder-rules` | 管理提醒规则 |
| 通知设置 | GET/PUT | `/api/v1/notification-settings` | 管理通知渠道设置 |
