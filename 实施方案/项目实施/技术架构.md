...
- **状态管理**: 本地状态管理 + Context API
- **路由**: React Router DOM 7.7.1（受保护路由和懒加载）
- **HTTP客户端**: Axios 1.11.0（API请求和拦截器）
- **甘特图库**: gantt-task-react 0.3.9（交互式甘特图组件）
